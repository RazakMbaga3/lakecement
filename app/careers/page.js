...
export default function CareersPage() {
  ...
  return (
    <>
      {/* Compact Hero Banner with Parallax */}
      <div className="relative w-full h-52 overflow-hidden">
        ...
        >
          <Image 
            src="/images/contactus/career-banner.jpg" 
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-white text-5xl Iinline-block font-bold mb-2 relative">
                Careers
              </h1>
              <p className="text-white/90 text-base md:text-base">
                Join our team and contribute to Tanzania's leading cement manufacturer
              </p>
            </motion.div>
          </div>
        </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-base font-bold mb-1 text-blue-900">Professional Growth</h3>
                    <p className="text-gray-700 text-sm">Opportunities for career advancement and professional development.</p>
                  </div>
                </motion.div>
